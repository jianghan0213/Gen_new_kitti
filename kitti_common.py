...
def encode_label(P, ry, dims, locs, img_shape):
    l, h, w = dims[0], dims[1], dims[2]
    x, y, z = locs[0], locs[1], locs[2]
    ...
    box2d = np.maximum(box2d, 0)
    box2d[[0,2]] = np.minimum(box2d[[0,2]], img_shape[1]-1)
    box2d[[1,3]] = np.minimum(box2d[[1,3]], img_shape[0]-1)
